...
экспортируемые цвета вершин. Скелет с простыми жёсткими весами и клипы Idle, Talk, Wave, DJ.
...
Лицо и силуэт пока приближённые. Шерсть — геометрический прототип, не готовый groom.
